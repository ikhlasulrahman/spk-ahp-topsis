...
<div class="page-header">
    ...
    <form class="form-inline" action="" method="get">
        ...
        <div class="form-group">
            <button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-list-alt"></span> Set Kategori</button>
        </div>
    </form>
</div>
<?php
...
<div class="panel panel-primary">
    ...
    <div class="panel-body oxa">
        <table class="table table-bordered table-striped table-hover">
            ...
            // Urutkan $pref dari yang terbesar ke terkecil
            arsort($pref); 

            $no = 1; // Nomor ranking mulai dari 1
