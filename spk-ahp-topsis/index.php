    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li class="<?= isActive(['periode', 'periode_tambah']) ?>" class="?m=periode"><a href="?m=periode&periode=<?= get('periode') ?>"><span class="glyphicon glyphicon-list-alt"></span> Kategori</a></li>
          ...
          <li class="<?= isActive(['alternatif', 'rel_alternatif', 'alternatif_tambah', 'alternatif_ubah', 'rel_alternatif_ubah']) ?>" class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li class="<?= isActive(['alternatif', 'alternatif_tambah', 'alternatif_ubah']) ?>"><a href="?m=alternatif&periode=<?= get('periode') ?>"><span class="glyphicon glyphicon-user"></span> Alternatif Pemain</a></li>
              <li class="<?= isActive(['rel_alternatif', 'rel_alternatif_ubah']) ?>"><a href="?m=rel_alternatif&periode=<?= get('periode') ?>"><span class="glyphicon glyphicon-signal"></span> Nilai bobot alternatif</a></li>
            </ul>
          </li>
          ...
          <li class="<?= isActive(['akun', 'alternatif_tambah', 'alternatif_ubah']) ?>"><a href="?m=akun"><span class="glyphicon glyphicon-user"></span> Akun</a></li>
