...
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post">
            <!-- Kolom tahun dihilangkan karena auto_increment -->
            <!-- <div class="form-group">
                <label for="tahun">Tahun <span class="text-danger">*</span></label>
                <input class="form-control" type="number" name="tahun" id="tahun" value="<?= set_value('tahun') ?>" required />
            </div> -->
            <div class="form-group">
                <label for="nama">Nama Kategori Posisi <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama" id="nama" value="<?= set_value('nama') ?>" required />
            </div>
            <div class="form-group">
                <label for="keterangan">Keterangan</label>
                <textarea name="keterangan" id="keterangan" cols="3" class="form-control"><?= set_value('keterangan') ?></textarea>
            </div>
            <div class="form-group">
