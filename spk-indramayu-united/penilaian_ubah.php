<?php
$row = $db->get_row("SELECT * FROM tb_penilaian WHERE id_penilaian='" . get('id_penilaian') . "'");
$nama_lini = $db->get_var("SELECT nama FROM tb_lini WHERE id_lini='$row->id_lini'");
?>
<div class="page-header">
    <h1>Ubah Sesi Penilaian</h1>
    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <a class="btn btn-info" href="?m=penilaian&id_lini=<?= $row->id_lini ?>"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
            </div>
        </form>
    </div>
</div>