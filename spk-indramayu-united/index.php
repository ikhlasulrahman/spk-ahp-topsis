...
<body>
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <?php if ($_SESSION['level'] != '3') : // Menu untuk Pelatih (1) dan Manajer (2) ?>
            ...
            <li class="<?= isActive('hitung') ?>"><a href="?m=hitung&periode=<?= get('periode') ?>"><span class="glyphicon glyphicon-calendar"></span> Skor Akhir</a></li>
            <li class="<?= isActive('laporan') ?>"><a href="?m=laporan"><span class="glyphicon glyphicon-list-alt"></span> Laporan</a></li>          
            <?php endif; ?>
  ...
  <div class="container">
    ...
    $allowed_modules = [];
    if ($level == '1') { // Pelatih
        $allowed_modules = ['home', 'periode', 'periode_tambah', 'periode_ubah', 'kriteria', 'kriteria_tambah', 'kriteria_ubah', 'rel_kriteria', 'alternatif', 'alternatif_tambah', 'alternatif_ubah', 'rel_alternatif', 'rel_alternatif_ubah', 'hitung', 'laporan', 'profil'];
    } else if ($level == '2') { // Manajer
        $allowed_modules = ['home', 'periode', 'kriteria', 'rel_kriteria', 'alternatif', 'rel_alternatif', 'hitung', 'laporan', 'profil'];
