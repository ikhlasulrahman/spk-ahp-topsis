...
<body>
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <?php if ($_SESSION['level'] != '3') : // Menu untuk Pelatih (1) dan Manajer (2) ?>
            <li class="<?= isActive(['lini', 'lini_tambah', 'lini_ubah']) ?>"><a href="?m=lini"><span class="glyphicon glyphicon-list-alt"></span> Lini</a></li>
            ...
            <li class="<?= isActive('hitung') ?>"><a href="?m=hitung&id_lini=<?= get('id_lini') ?>"><span class="glyphicon glyphicon-calendar"></span> Skor Akhir</a></li>
  ...
  <div class="container">
    ...
    $allowed_modules = [];
    if ($level == '1') { // Pelatih
        $allowed_modules = ['home', 'lini', 'lini_tambah', 'lini_ubah', 'kriteria', 'kriteria_tambah', 'kriteria_ubah', 'rel_kriteria', 'alternatif', 'alternatif_tambah', 'alternatif_ubah', 'rel_alternatif', 'rel_alternatif_ubah', 'hitung', 'laporan', 'pilih_cetak', 'profil'];
    } else if ($level == '2') { // Manajer
        $allowed_modules = ['home', 'lini', 'kriteria', 'rel_kriteria', 'alternatif', 'rel_alternatif', 'hitung', 'laporan', 'pilih_cetak', 'profil'];
    ...
    if ($mod && file_exists($mod . '.php')) {
        ...
        $lini_related_pages = ['kriteria', 'rel_kriteria', 'kriteria_tambah', 'kriteria_ubah', 'alternatif', 'rel_alternatif', 'alternatif_tambah', 'alternatif_ubah', 'rel_alternatif_ubah', 'hitung'];
