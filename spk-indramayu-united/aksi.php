...
elseif ($mod == 'periode_tambah') {
    ...
    if ($nama == '' || $kebutuhan < 1)
        ...
        $db->query("INSERT INTO tb_periode (nama, kebutuhan, keterangan) VALUES ('$nama', '$kebutuhan', '$keterangan')");
    ...
    if ($tahun == '' || $nama == '' || $kebutuhan < 1)
        print_msg("Field bertanda * tidak boleh kosong dan kebutuhan minimal 1!", "danger");
    else {
        $db->query("UPDATE tb_periode SET nama='$nama', kebutuhan='$kebutuhan', keterangan='$keterangan' WHERE tahun='" . get('ID') . "'");
