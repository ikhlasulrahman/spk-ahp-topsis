...
<?php
// --- TAMBAHKAN KODE INI ---
// Mengambil semua data alternatif (termasuk jabatan) untuk periode ini
$alternatifs_data = array();
$rows_alternatif = $db->get_results("SELECT kode_alternatif, nama_alternatif, jabatan FROM tb_alternatif WHERE tahun=$PERIODE");
...
<div class="panel panel-primary">
    ...
    <?php
$kebutuhan = (int) $db->get_var("SELECT kebutuhan FROM tb_periode WHERE tahun='$PERIODE'");
if($kebutuhan > 0):
    $terpilih = $db->get_results("SELECT * FROM tb_alternatif WHERE tahun=$PERIODE ORDER BY rank ASC LIMIT $kebutuhan");
?>
<div class="panel panel-terpilih">
    <div class="panel-heading"><strong>Pemain Terpilih (Kebutuhan: <?= $kebutuhan ?> Orang)</strong></div>
    <div class="panel-body oxa">
