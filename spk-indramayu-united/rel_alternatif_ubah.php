...
<div class="row">
    ...
    INNER JOIN tb_kriteria k ON k.kode_kriteria = ra.kode_kriteria AND k.id_lini = ra.id_lini
    WHERE ra.kode_alternatif = '" . get('ID') . "' AND ra.id_lini = '$ID_LINI'
...
");
            ...
            <a class="btn btn-info" href="?m=rel_alternatif"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
        </form>
    </div>
</div>