        ...
        <div class="form-group">
            <select class="form-control" name="periode">
                <?php foreach ($periodes as $periode) { ?>
                    <option value="<?= $periode->tahun ?>" <?= $periode->tahun == get('periode') ? 'selected' : '' ?>><?= htmlspecialchars($periode->nama) ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group">
...
<?php
// Mengambil semua kriteria untuk periode yang aktif
$kriteria = $db->get_results("SELECT kode_kriteria, nama_kriteria FROM tb_kriteria WHERE tahun = '$PERIODE' ORDER BY kode_kriteria");
...
?>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="aksi.php?m=rel_kriteria&periode=<?= get('periode') ?>" method="post">
